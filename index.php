	...
	foreach($events['events'] as $event)
	{
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text')
		{
			...
			if (ereg_replace('[[:space:]]+', '', trim($text)) == "7"){
				...
				$messages = ['type' => 'text', 'text' => "ตารางคำนวณแม่ปุ๋ยเพื่อนำมาผสมใช้เอง" ."\n" . "คำนวณหาแม่ปุ๋ยมาผสมทำปุ๋ยโดยใช้ Microsoft Excel" .  "\n" ."\n" . "ตารางคำนวณแม่ปุ๋ยที่ต้องใช้ผสมสำหรับต้นยางพาราอายุ 1-2 ปี" . "\n" . "https://docs.google.com/spreadsheets/d/1HKA610ClbB0WvbL24hVPY5J3llwyoTYj0ShoLDFefsQ/edit?usp=sharing" . "\n" . "ตารางคำนวณหาแม่ปุ๋ยที่ต้องใช้ผสมสำหรับต้นยางพาราอายุ 3-6 ปี" . "\n" . "https://docs.google.com/spreadsheets/d/1D2UDBsRJbKkm_9qxKTnp4YlLf3sOUy4_-pwcrPbwDWM/edit?usp=sharing" . "\n" . "ตารางคำนวณหาแม่ปุ๋ยที่ต้องนำมาผสมสำหรับต้นยางพาราอายุ 7-15 ปี" . "\n"  . "https://docs.google.com/spreadsheets/d/19v882IRvIiu7aWmcmD0O8uS3xqF79Kv3yUGpB-dJeGs/edit?usp=sharing" . "\n" . "ตารางคำนวณหาแม่ปุ๋ยเพื่อนำมาผสมสำหรับต้นยางพาราอายุ 15 ปี ขึ้นไป" . "\n" . "https://docs.google.com/spreadsheets/d/1wVEHS3VQp6miQkqq2_gFdO3kElV8YWMrYqL3kSgRaTc/edit?usp=sharing" . "\n" . "[H] เพื่อดูเมนู"];
			}
			...
			if (ereg_replace('[[:space:]]+', '', trim($text)) == "8"){
				...
				$messages = ['type' => 'text', 'text' => "ตารางคำนวณวัสดุธรมมชาติเพื่อนำมาผสมปุ๋ยอินทรีย์ใช้เอง" ."\n" . "คำนวณหาแม่ปุ๋ยมาผสมทำปุ๋ยโดยใช้ Microsoft Excel" .  "\n" ."\n" . "ตารางคำนวณวัสดุธรรมชาติที่ต้องใช้ผสมสำหรับต้นยางพาราอายุ 1-2 ปี" . "\n" . "https://docs.google.com/spreadsheets/d/1p_Sk6Z5f5mmITHZii_lTA8am0EjGWizeYT-tzNmvsjQ/edit?usp=sharing" . "\n" . "ตารางคำนวณหาวัสดุธรรมชาติที่ต้องใช้ผสมสำหรับต้นยางพาราอายุ 3-6 ปี" . "\n" . "https://docs.google.com/spreadsheets/d/1hSbXbXl0_EVeaoKq1095G679Eb_6Erx6vxlWGZVo9_k/edit?usp=sharing" . "\n" . "ตารางคำนวณหาวัสดุธรรมชาติที่ต้องนำมาผสมสำหรับต้นยางพาราอายุ 7-15 ปี" . "\n"  . "https://docs.google.com/spreadsheets/d/13uIWQLl-_Nsh-uupjstWGSf65o0R651AM-Pf4V-vato/edit?usp=sharing" . "\n" . "ตารางคำนวณหาวัสดุธรรมชาติเพื่อนำมาผสมสำหรับต้นยางพาราอายุ 15 ปี ขึ้นไป" . "\n" . "https://docs.google.com/spreadsheets/d/10GsE0jQyI93rtjg6eXL8na9ysC-XbRtjNM-E_81H4yw/edit?usp=sharing" . "\n" . "[H] เพื่อดูเมนู"];
			}
