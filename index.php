	...
	foreach($events['events'] as $event)
	{
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text')
		{
			...
			if (ereg_replace('[[:space:]]+', '', trim($text)) == "ราคายาง"){
				...
				$messages = ['type' => 'text', 'text' => "ราคายางวันนี้ : " . "ข้อมูลจากการยางแห่งประเทศไทย" .  "\n" . "ราคากลางเปิดตลาด ประจำวันนี้อยู่ที่ 45.45 บาท/กก. โดยปิดตลาดสูงสุด ณ 3 ตลาด ได้แก่ ตลาดกลางสงขลา ตลาดกลางสุราษฎร์ธานีและตลาดกลางนครศรีธรรมราช ราคาอยู่ที่ 44.97 บาท/กก" . "\n" . "ราคาเปิดตลาดอยู่ที่ 45.45บาท/กก." . "\n" . "ราคาปิดตลาดอยู่ที่ 44.97บาท/กก." .  "\n" . "[มีอะไรบ้าง] เพื่อดูเมนู"];
			}
